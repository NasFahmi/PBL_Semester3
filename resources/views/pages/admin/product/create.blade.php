        ...
        <div class="bg-white flex justify-center items-center px-8 py-8 shadow-lg rounded-3xl">
            ...
            <form action="" method="post" class="">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div class="left">
                        <div class="">
                            ...
                            <input type="text" placeholder="Nama Product"
                        ...
                        <div class="">
                            ...
                            <div class="grid grid-cols-2 justify-start items-center gap-4 max-w-sm mb-3">
                                <input type="text" placeholder="Rendah"
                        ...
                        <div class="">
                            ...
                            <input type="text" placeholder="Link Shopee"
                        ...
                        <div class="">
                            ...
                            <textarea class="textarea textarea-info w-full max-w-sm bg-slate-50" placeholder="Spesifikasi Product" name="deskripsi"
                                rows="4"></textarea>
                        </div>
                    ...
                    <div class="right">
                            ...
                            <ul
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="vue-checkbox" type="checkbox" value="Kecil"
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="react-checkbox" type="checkbox" value="Sedang"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="angular-checkbox" type="checkbox" value="Besar"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="laravel-checkbox" type="checkbox" value="Sangat Besar"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="laravel-checkbox"
                                            class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sangat Besar</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="form-container">
                            ...
                            <div class="form-group flex justify-center items-center gap-2">
                                {{-- <input type="text"  placeholder="Varian Produk"
                                class="input input-bordered input-info w-full max-w-sm duration-50 bg-slate-50  mb-3" />
                                <div class="w-8 h-8 cursor-pointer" onclick="removeInput(this)" >
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="10" stroke="#e21818" stroke-width="1.5"></circle> <path d="M15 12H9" stroke="#e21818" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                                </div> --}}
                            </div>
                          </div>
                ...
                <div class="flex justify-center items-center mt-3">
                    <a href="" class="text-center focus:outline-none text-white w-full md:w-fit bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-3 me-2 mb duration-300 whitespace-nowrap">Next</a>
                </div>
            </form>
        </div>
    </div>
