        ...
        <div class="bg-white flex justify-center items-center px-8 py-8 shadow-lg rounded-3xl">
            ...
            <form action="{{route('product.store')}}" method="post" class="">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div class="left">
                        ...
                        <div class="">
                            ...
                            <textarea class="textarea textarea-info w-full max-w-sm bg-slate-50" placeholder="Spesifikasi Product" name="spesifikasi_product"
                                rows="4"></textarea>
                        </div>
                            ...
                            <ul
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="kecil" type="checkbox" value="Kecil" name="beratjenis[kecil]" 
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="Sedang" type="checkbox" value="Sedang" name="beratjenis[sedang]"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="Sedang"
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="Besar" type="checkbox" value="Besar" name="beratjenis[besar]"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                        <label for="Besar"
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center ps-3">
                                        <input id="Sangat Besar" type="checkbox" value="Sangat Besar" name="beratjenis[sangat_besar]"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                ...
                <div class="flex justify-center items-center mt-3">
                    <button type="submit" class="text-center focus:outline-none text-white w-full md:w-fit bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-3 me-2 mb duration-300 whitespace-nowrap">Next</button>
                </div>
            </form>
        </div>
    </div>
