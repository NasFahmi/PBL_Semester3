...
@section('content')
    <div class="container px-6 pb-6 mx-auto ">
        ...
        <div class="bg-white w-full px-8 py-4 shadow-md rounded-3xl mb-4 flex justify-start items-center  lg:w-full">
        ...
        <div class="bg-white p-8 shadow-lg rounded-3xl   lg:w-full">
            <div class="overflow-x-auto ">
                <table class=" text-sm text-left table-auto w-full">
                    ...
                    <tbody>
                        <tr
                            class="px-4 py-2 odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <tr
                            ...
                            <th scope="row"
                                class="mx-10  px-4 py-2 w-10 h-16 pl-3 font-medium text-gray-900 lg:whitespace-nowrap">
                                Product A
                            </th>
                            <td class="w-10 h-16 mx-10  px-4 py-2 lg:whitespace-nowrap">
                                Jhone Doe
                            </td>
                            <td class="w-10 h-16 mx-10  px-4 py-2 lg:whitespace-nowrap">
                                20
