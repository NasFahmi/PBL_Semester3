...
@section('content')
    <div class="container px-6 pb-6 mx-auto">
        ...
        <div class="bg-white w-full px-8 py-4 shadow-md rounded-3xl mb-4 flex justify-start items-center">
            <div class="flex justify-start items-start md:items-center flex-col gap-4 w-full ">
                <form class="flex items-center w-full lg:w-1/2" action="" method="GET">
                    <label for="simple-search" class="sr-only">Search</label>
                    <div class="relative w-full">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-500" aria-hidden="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="" class="bg-green-200 px-4 w-full md:w-fit py-2 rounded-3xl flex justify-center items-center gap-1 ">
                    <div class="w-4 h-4">
        ...
        <div class="bg-white w-full px-8 py-8 shadow-lg rounded-3xl">
            <div class="overflow-x-auto ">
              <table class="w-full overflow-x=auto text-sm text-left table-auto ">
                ...
                <tbody>
                    <tr class="px-4 py-2 odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        <th scope="row" class=" font-medium  text-sm">
                          <span class="text-sm">Product A</span>
                        </th>
                        <td class="">
                          <span class="text-sm">Jhone Doe</span>
                        </td>
                        <td class="">
                        ...
                        <td class="">
                          <div class="flex justify-center items-center">
                            <div class="w-6 h-6" data-dropdown-toggle="dropdown1">
                        ...
                        <div id="dropdown1"
                            ...
                            <ul class="text-sm text-gray-700 dark:text-gray-200 rounded-3xl"
                                ...
                                <li>
                                    <a href="#" class="block px-4 py-2 hover:bg-sky-100 bg-sky-50">
                                        <div class="flex justify-start items-center gap-2">
                                            ...
                                            <span
                                                class="font-semibold text-sky-400 ">Details</span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                      ...
                      <td class="">
                        <div class="bg-red-200 px-4 py-2 w-fit h-fit rounded-3xl flex justify-center items-center">
                            <span class="text-red-500 font-semibold">Belum Selesai</span>
                        </div>
                      </td>
                      <td class="">
                        <div class="flex justify-center items-center">
                          <div class="w-6 h-6" data-dropdown-toggle="dropdown2">
                              <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                  xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"
                                  transform="rotate(90)">
                                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
