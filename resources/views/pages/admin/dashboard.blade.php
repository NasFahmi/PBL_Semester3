            ...
            <div class="overflow-y-auto costumscroll  rounded-lg max-h-80">
                ...
                <div class="bg-teal-100 rounded-md p-4 mb-4">
                    <div class="flex justify-start items-center gap-4 mb-2">
                        ...
                        <div class="">
                            <h1 class="text-gray-800 text-lg font-semibold">Product A</h1>
                            <p class="text-gray-700">Total Order : 120</p>
                        </div>
                    </div>
                    <p class="text-gray-700 font-medium">Nama : Jhon Doe</p>
                    <p class="text-gray-500 text-sm mb-4">Keterangan : Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Sunt, voluptatum. </p>
                    <p class="text-sm text-right">21 Agustus 2023 17:30</p>
                </div>
                ...
                <div class="bg-teal-100 rounded-md p-4 mb-4">
                    <div class="flex justify-start items-center gap-4 mb-2">
                        ...
                        <div class="">
                            <h1 class="text-gray-700 text-lg font-semibold">Product A</h1>
                            <p class="text-gray-600">Total Order : 120</p>
                        </div>
                    </div>
                    <p class="text-gray-600 font-medium">Nama : Jhon Doe</p>
                    <p class="text-gray-500 text-sm mb-4">Keterangan : Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Sunt, voluptatum. </p>
                    <p class="text-sm text-right">21 Agustus 2023 17:30</p>
                </div>
