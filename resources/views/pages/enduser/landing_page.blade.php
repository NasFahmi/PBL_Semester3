...
@section('content')
            ...
            <div class="drawer-content flex flex-col">
                ...
                <div class="px-10 md:px-20 mt-20 mb-60">
                    ...
                    <div class="w-full md:w-3/4 lg:w-1/2">
                        <p class="text-lg md:text-base text-white font-light tracking-wide leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 ">
                <div class="flex justify-center items-center">
                    <div class="flex justify-center items-center flex-col mt-8 bg-blue-200 p-10 rounded-xl w-10/12 shadow-xl">
                        ...
                        <div class="w-full mt-5">
                            <p class="text-sm text-center">Produk kami sudah ada di 20 pusat oleh -oleh dibanyuwangi,
                ...
                <div class="flex justify-center items-center">
                    <div class="flex justify-center items-center flex-col mt-8 bg-blue-200 p-10 rounded-xl w-10/12 shadow-xl">
                        ...
                        <div class="w-full mt-5">
                            <p class="text-sm text-center">Kami juga melayani pembelian melalui sosial media, seperti
                ...
                <div class="flex justify-center items-center">
                    <div class="flex justify-center items-center flex-col mt-8 bg-blue-200 p-10 rounded-xl w-10/12 shadow-xl ">
                        ...
                        <div class="w-full mt-5">
                            <p class="text-sm text-center">Kami juga berperan aktif dalam acara pameran dari beberapa dinas
                                yang menaungi.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-blue-200 pb-10 md:mt-28 rounded-3xl shadow-xl">
        ...
        <div id="keungulan"
            ...
            <div class="ml-4 md:w-1/2">
                ...
                <div class="hidden md:flex justify-start items-start">
                    <a href="{{ route('katalog') }}"
                        class="w-1/2 px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#276ED8] border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700">Lihat
                        Semua Product</a>
                </div>
            </div>
                        ...
                        @foreach ($data as $product)
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                @foreach ($product->fotos as $items)
                                    <img src="{{ asset('storage/' . $items->foto) }}" @endforeach
        ...
        <div class="md:hidden flex justify-center items-center px-8">
            <a href="{{ route('katalog') }}"
                class="w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#276ED8] border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700">Lihat
                Semua Product</a>
        </div>
    </div>
    {{-- section 7 --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-start gap-8 md:gap-0">
                ...
                <div class="flex justify-start items-center flex-col">
                    ...
                    <div class="w-3/4 lg:w-5/12 mt-5">
                        ...
                        <p class="text-sm text-center">Banyak dari kegagalan hidup adalah orang-orang yang tidak menyadari
