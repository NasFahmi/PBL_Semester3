...
@section('content')
    <div class="flex items-center min-h-screen p-6 bg-gray-50 ">
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl pt-10 md:pt-0">
          <h1 class="mb-4 ml-10 mt-5 text-xl font-semibold text-gray-700 ">PAWONKOE</h1>
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <label class="block text-sm">
                            <span class="text-gray-700 ">Email</span><span class="text-red-600 ">*</span>
                            <input type="email"
                        ...
                        <a class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#276ED8] border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple"
                            href="">
                            Log in
                        </a>
